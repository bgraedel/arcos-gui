from arcos_gui.shape_functions import COLOR_CYCLE, assign_color_id, format_verticesHull, get_verticesHull, format_verticesHull, make_shapes
import pytest
import pandas as pd
import numpy as np
...
def test_format_verticesHull(data_frame):
    ...
    d_2 = [[0,'polygon',0,1,5,0,1],[0, 'polygon', 1,1,6,9,1],[0,'polygon',2,1,10,5,1]]
    cols_2 = ['index','shape-type','vertex-index','axis-0','axis-1', 'axis-2', 'collid']
...
def test_make_shapes(data_frame):
    ...
    dict_exp =  {'face_color': ['#1f77b4'], 'data': [np.array([[ 1,  5,  0],[ 1,  6,  9],[ 1, 10,  5]])]}
